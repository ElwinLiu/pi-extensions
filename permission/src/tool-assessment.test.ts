...
const SINGLE_COMMAND_CASES: BashCase[] = [
	...
	{ name: "npx tsx test", command: "npx --yes tsx --test agent/extensions/permission/src/tool-assessment.test.ts", expectedLevel: "medium" },
	...
	{ name: "rm file", command: "rm /Users/elwin/.pi/agent/extensions/permission/policy.ts", expectedLevel: "high" },
	{ name: "rm -f file", command: "rm -f /Users/elwin/.pi/agent/extensions/permission/ai-risk.ts", expectedLevel: "high" },
